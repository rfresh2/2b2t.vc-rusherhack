...
public class VcPlugin extends Plugin {
    ...
    public void onLoad() {
        ...
        final Queue queue = new Queue(api);
        ...
        RusherHackAPI.getCommandManager().registerFeature(new QueueCommand(api, queue));
        RusherHackAPI.getCommandManager().registerFeature(new StatsCommand(api));
        final Queue2b2tHudElement queueHud = new Queue2b2tHudElement(api, queue);
